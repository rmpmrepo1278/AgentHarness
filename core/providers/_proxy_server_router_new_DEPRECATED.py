    def _get_router():
        ...
        # Routing Table — prioritized by speed (fastest first to minimize latency)
        # Groq ~300t/s, Cerebras ~250t/s, SambaNova ~150t/s, Owl/OpenRouter variable
        tier_order = ["groq", "cerebras", "sambanova", "mistral", "owl", "google-alt", "local"]
