...
TOOL_SCHEMAS = [
    {"name": "doctor_status", "description": "Get homelab health status. Returns overall status and per-service checks.", "inputSchema": {"type": "object", "properties": {}}},
    {"name": "doctor_runbooks", "description": "List available doctor runbooks (auto-fix scripts for common issues).", "inputSchema": {"type": "object", "properties": {}}},
    {"name": "doctor_heal", "description": "Run a doctor runbook by name to auto-fix a specific issue.",        "inputSchema": {"type": "object", "properties": {"name": {"type": "string", "description": "Runbook name to execute"}}, "required": ["name"]}},
]
...
def main():
    ...
    s.register_handler("doctor_status", __import__('infrastructure.doctor', fromlist=['doctor_status']).doctor_status)
    ...
    log.info("Doctor MCP starting on :8105")
    s.start()
